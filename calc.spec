...
Source0  : https://github.com/lcn2/calc/releases/download/2.12.7.6/calc-2.12.7.6.tar.bz2
...
%prep
%setup -q -n calc-2.12.7.6
cd %{_builddir}/calc-2.12.7.6
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612543303
...
cp %{_builddir}/calc-2.12.7.6/COPYING %{buildroot}/usr/share/package-licenses/calc/ac5b4dd239458d463b8be5b834e0398a88265ae3
cp %{_builddir}/calc-2.12.7.6/COPYING-LGPL %{buildroot}/usr/share/package-licenses/calc/fc024cea7b58639d903adbe7015b34ee1584ced8
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcalc.so.2.12.7.6
/usr/lib64/libcustcalc.so.2.12.7.6
