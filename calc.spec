...
Version  : 2.15.0.5
Release  : 25
URL      : https://github.com/lcn2/calc/releases/download/v2.15.0.5/calc-2.15.0.5.tar.bz2
Source0  : https://github.com/lcn2/calc/releases/download/v2.15.0.5/calc-2.15.0.5.tar.bz2
...
%prep
%setup -q -n calc-2.15.0.5
cd %{_builddir}/calc-2.15.0.5
pushd ..
cp -a calc-2.15.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706886981
...
/usr/lib64/libcalc.so.2.15.0.5
/usr/lib64/libcustcalc.so.2.15.0
/usr/lib64/libcustcalc.so.2.15.0.5
