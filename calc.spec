...
Version  : 2.15.0.4
Release  : 24
URL      : https://github.com/lcn2/calc/releases/download/v2.15.0.4/calc-2.15.0.4.tar.bz2
Source0  : https://github.com/lcn2/calc/releases/download/v2.15.0.4/calc-2.15.0.4.tar.bz2
...
%prep
%setup -q -n calc-2.15.0.4
cd %{_builddir}/calc-2.15.0.4
pushd ..
cp -a calc-2.15.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704922900
...
/usr/lib64/libcalc.so.2.15.0.4
/usr/lib64/libcustcalc.so.2.15.0
/usr/lib64/libcustcalc.so.2.15.0.4
