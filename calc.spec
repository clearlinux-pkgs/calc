...
Version  : 2.15.1.1
Release  : 28
URL      : https://github.com/lcn2/calc/releases/download/v2.15.1.1/calc-2.15.1.1.tar.bz2
Source0  : https://github.com/lcn2/calc/releases/download/v2.15.1.1/calc-2.15.1.1.tar.bz2
...
%prep
%setup -q -n calc-2.15.1.1
cd %{_builddir}/calc-2.15.1.1
pushd ..
cp -a calc-2.15.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745503474
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcalc.so.2.15.1
/usr/lib64/libcalc.so.2.15.1.1
/usr/lib64/libcustcalc.so.2.15.1
/usr/lib64/libcustcalc.so.2.15.1.1
