...
Source0  : https://github.com/lcn2/calc/releases/download/v2.12.9.1/calc-2.12.9.1.tar.bz2
...
%prep
%setup -q -n calc-2.12.9.1
cd %{_builddir}/calc-2.12.9.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617025483
...
cp %{_builddir}/calc-2.12.9.1/COPYING %{buildroot}/usr/share/package-licenses/calc/7691593eb77c510de17606cb568c418b7b4096ed
cp %{_builddir}/calc-2.12.9.1/COPYING-LGPL %{buildroot}/usr/share/package-licenses/calc/fc024cea7b58639d903adbe7015b34ee1584ced8
...
/usr/include/calc/have_ban_pragma.h
...
/usr/include/calc/have_strlcat.h
/usr/include/calc/have_strlcpy.h
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcalc.so.2.12.9.1
/usr/lib64/libcustcalc.so.2.12.9.1
