...
Version  : 2.12.8.1
Release  : 10
URL      : https://github.com/lcn2/calc/releases/download/2.12.8.1/calc-2.12.8.1.tar.bz2
Source0  : https://github.com/lcn2/calc/releases/download/2.12.8.1/calc-2.12.8.1.tar.bz2
...
%prep
%setup -q -n calc-2.12.8.1
cd %{_builddir}/calc-2.12.8.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613488064
...
cp %{_builddir}/calc-2.12.8.1/COPYING-LGPL %{buildroot}/usr/share/package-licenses/calc/fc024cea7b58639d903adbe7015b34ee1584ced8
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libcalc.so.2.12.8.1
/usr/lib64/libcustcalc.so.2.12.8.1
