...
Version  : 2.15.1.0
Release  : 27
URL      : https://github.com/lcn2/calc/releases/download/v2.15.1.0/calc-2.15.1.0.tar.bz2
Source0  : https://github.com/lcn2/calc/releases/download/v2.15.1.0/calc-2.15.1.0.tar.bz2
...
%prep
%setup -q -n calc-2.15.1.0
cd %{_builddir}/calc-2.15.1.0
pushd ..
cp -a calc-2.15.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720794454
...
/usr/lib64/libcalc.so.2.15.1.0
/usr/lib64/libcustcalc.so.2.15.1
/usr/lib64/libcustcalc.so.2.15.1.0
